...
const Products = () => {
  ...
  console.log("not in cart", orders);
            ...
            <div key={index}>
              ...
              <div className="bg-gray-100 p-4 relative">
                <button
                  ...
                  className="bg-blue-100 right-0 top-2 absolute text-primary-800 text-xs font-medium mr-2 px-2.5 p-2 rounded-full dark:bg-blue-900 dark:text-primary-300 hover:bg-primary-800 hover:text-white"
                >
                  Show More
                </button>
